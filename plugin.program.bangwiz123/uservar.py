...
THEME1 = u'Bang Wizards [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing Bang Wwizard You know how to contact us'
...
REPOADDONXML = 'https://raw.githubusercontent.com/hidemyassbaby/repository.bangvnine/master/zips/addons.xml'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]Bang[/B][/COLOR]Wizard'
